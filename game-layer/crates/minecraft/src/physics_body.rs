    ...
    match axis {
            ...
            if velocity_component > 0.0 {
                ...
                for y in min_y..=max_y {
                    for z in min_z..=max_z {
                        if dimension.get_block(GlobalCoords::from((max_x as GlobalCoordsType, y as GlobalCoordsType, z as GlobalCoordsType))).get_type().is_solid() {
                ...
                for y in min_y..=max_y {
                    for z in min_z..=max_z {
                        if dimension.get_block(GlobalCoords::from((min_x as GlobalCoordsType, y as GlobalCoordsType, z as GlobalCoordsType))).get_type().is_solid() {
                            // Вычитаем EPSILON
        ...
        'y' => {
            ...
            if velocity_component > 0.0 {
                ...
                for x in min_x..=max_x {
                    for z in min_z..=max_z {
                        if dimension.get_block(GlobalCoords::from((x as GlobalCoordsType, max_y as GlobalCoordsType, z as GlobalCoordsType))).get_type().is_solid() {
                ...
                for x in min_x..=max_x {
                    for z in min_z..=max_z {
                        if dimension.get_block(GlobalCoords::from((x as GlobalCoordsType, min_y as GlobalCoordsType, z as GlobalCoordsType))).get_type().is_solid() {
        ...
        'z' => {
            ...
            if velocity_component > 0.0 {
                ...
                for x in min_x..=max_x {
                    for y in min_y..=max_y {
                        if dimension.get_block(GlobalCoords::from((x as GlobalCoordsType, y as GlobalCoordsType, max_z as GlobalCoordsType))).get_type().is_solid() {
                ...
                for x in min_x..=max_x {
                    for y in min_y..=max_y {
                        if dimension.get_block(GlobalCoords::from((x as GlobalCoordsType, y as GlobalCoordsType, min_z as GlobalCoordsType))).get_type().is_solid() {
